...
<body>
	<main id="taskPage">
		<section id="taskCreation" class="not">
			<form id="taskForm">
				...
				<div>
					...
					<g:select id="categoria" name="categoria" from="${tasks.Category.list()}" optionKey="id" required="" value="${taskInstance?.categoria?.id}" class="many-to-one"/>
				</div>
				<nav>
		...
		<section>
			...
			<nav class="bottom">
				<g:link controller="category" action="index">Adicionar Categorias</g:link>
			</nav>
		</section>
	</main>
